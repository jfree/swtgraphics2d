 ...
 * implementation).  Here we test the SWTGraphics2D class.  Currently, not all
 * of the tests pass (most of the failures are in the area of clipping).
 */
public class SWTGraphics2DTest {
    ...
    public void setUp() {
        if (TEST_REFERENCE_IMPLEMENTATION) {
            ...
            org.eclipse.swt.graphics.Image image = new org.eclipse.swt.graphics.Image(display, (int) 200, (int) 200);
            GC gc = new GC(image);
            this.g2 = new SWTGraphics2D(gc);
        }
    }
